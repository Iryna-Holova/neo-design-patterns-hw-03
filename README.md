...
[Stripe] Capturing transaction tmwczg
[Stripe] Refunding transaction tmwczg
...
[PayPal] Capturing transaction jugiji
[PayPal] Refunding transaction jugiji

# Запуск з Apple Pay провайдером
npx ts-node src/main.ts apple

# Приклад виведення
[Apple] Authorizing $100
[Apple] Capturing transaction ghuzyf
[Apple] Refunding transaction ghuzyf
```
